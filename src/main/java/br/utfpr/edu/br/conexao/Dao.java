...
public class Dao<T> {
    ...
    public List<T> validarReservaVoo(Long id_cliente, Long id_voo, String data) {
        EntityManager em = new JPAUtil().getEntityManager();
        Query q = em.createQuery("FROM " + classe.getSimpleName() + " WHERE cliente_Id = " + id_cliente + " and voo_Id = " + id_voo + " and dataReserva = '" + data + "'");
        return q.getResultList();
    }
    
    public List<T> validarReservaQuarto(Long id_cliente, Long id_voo, String data) {
        EntityManager em = new JPAUtil().getEntityManager();
        Query q = em.createQuery("FROM " + classe.getSimpleName() + " WHERE cliente_Id = " + id_cliente + " and quarto_Id = " + id_voo + " and dataReserva = '" + data + "'");
        return q.getResultList();
    }
    
     public List<T> consultaDisponivel(String data) {
        EntityManager em = new JPAUtil().getEntityManager();
        Query q = em.createQuery("FROM " + classe.getSimpleName() + " WHERE dataReserva <> '"+data+"'");
        return q.getResultList();
    }
