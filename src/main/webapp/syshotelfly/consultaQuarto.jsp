...
<html>
    <head>
       ...
       <script>
            jQuery(function($) {
                $("#ds_dataInicial").mask("99/99/9999", {placeholder: " "});
            });
        </script>
    </head>
    <body>
        ...
        <div id="wrap">
            <div class="container">
                ...
                <div class="page-header">
                    <h3>Consultar quartos</h3>
                </div>

                <form class="form-horizontal" action="../rest/quartodisponivel" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="ds_dataInicial" name="dataConsulta" type="text" placeholder="Data da reserva" class="form-control">
                            </div>
                        </div>
